...
> 公开版说明：部分私有目录只保留 README/template 占位，用于说明结构；真实个人资料、记忆、handoff、备份和归档内容不随公开版发布。
...
- `archive/README.md`：归档目录占位说明
- `backups/README.md`：备份目录占位说明
